        ...
        <Text style={{ fontSize: 40, fontWeight: 'bold',color:'white' }}>ADD TASK</Text>
            <View style={{
                ...
                <Text style={{fontSize: 25, fontWeight: 'bold', color:'black'}}>TIME : </Text>             
                    ...
                    {/* <TextInput 
                        value={time}
                        onChangeText={setTime} style={{backgroundColor:'white',color:'green',placeholder:'Add Credit',placeholderTextColor:'green',width:80,height:10,borderRadius:10,color:'black',fontcolor:'black'}}></TextInput> */}
